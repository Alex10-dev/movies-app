...
import 'package:movies/presentation/Views/movies/favorites_view.dart';
...
List<AppBottomTab> appTabs = [
  ...
  AppBottomTab(index: 2, route: 'favorites', icon: Icons.favorite_border_outlined, label: 'Favorites', view: FavoritesView()),
];